Primary care facilities are essential in delivering basic healthcare services, including diagnostic testing. Both the World Health Organization (WHO) [WHO_LAB_98.1.pdf](https://github.com/user-attachments/files/19316765/WHO_LAB_98.1.pdf)
...
## 4. Microbiology
- Smear for RTI/STDs
- Urine M/E for pus cells
- Smear examination for Leprosy
- Gram staining for clinical specimen
- Throat swab for Diphtheria
- Hanging drop test for V. cholera
- Stool routine examination including ova and parasite
- Stool for occult blood
- RPR Card test for syphilis
- rK39 test for Kala-Azar

## 5. Specific Diseases
- **Malaria**: Antigen-based bivalent RDT for malaria (Capillary/Venous whole blood)
- **Filariasis**: Peripheral blood smear (thick smear) (sent to PHC for microscopy)
- **Dengue**
- **Japanese encephalitis**
- **Scrub typhus**
- **Tuberculosis**: Sputum collection for TB (sent to PHC for microscopy)
- **HIV**: Pre-test counselling, HIV antibodies 1/2 test (RDT)
- **Hepatitis B**
- **Hepatitis C**

## 6. Other Diagnostic Tests
- **Visual Inspection with Acetic Acid (VIA) for cervical screening** (using vaginal speculum)
- **Water Quality Testing**:  
  - H₂S strip test kit for bacteriological quality  
  - Estimation of residual chlorine in drinking water (kit-based ortho-toluidine reagent method)

These tests are meant for routine diagnosis, disease surveillance, and preventive healthcare at the **Primary Health Care (PHC)** level.
...
| 10 | Haematology | Peripheral blood smear | Capillary blood | Microscopy |http://snomed.info/sct/104130000 |https://loinc.org/5909-7/| Grading System for abnormalities (e.g., 1+ to 4+ for severity) |Grade system |
| 11 | Haematology | Bleeding time | Whole blood | Manual |http://snomed.info/sct/72406003 |https://loinc.org/11067-6/|Measured in time duration|Minutes (min) & Seconds (sec) → Standard unit worldwide|
| 12 | Haematology | Clotting time | Whole blood | Manual |http://snomed.info/sct/165566005 |https://loinc.org/3184-9/ |Measured in time duration|Minutes (min) & Seconds (sec) → Standard unit worldwide|
